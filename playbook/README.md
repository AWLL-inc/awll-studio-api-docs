...
AWLL_BASE_URL=https://your-tenant.awll-studio.ai
AWLL_TENANT_CODE=your-tenant
```
...
```bash
source awll-api.sh
awll_login                    # 認証（トークン有効期限: 1時間）
awll_forms                    # データベース一覧
awll_answers <formId>         # レコード一覧
awll_get /api/v1/forms        # 任意のエンドポイントにGET
```
